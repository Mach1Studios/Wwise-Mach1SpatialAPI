...
#include "../SoundEnginePlugin/Mach1DecodePluginFXFactory.h"

Mach1DecodePluginAttachmentPlugin::Mach1DecodePluginAttachmentPlugin()
{
}
...
bool Mach1DecodePluginAttachmentPlugin::GetBankParameters(const GUID & in_guidPlatform, AK::Wwise::Plugin::DataWriter& in_dataWriter) const
{
...
ADD_AUDIOPLUGIN_CLASS_TO_CONTAINER(                 // Add our CLI class to the PluginContainer
    ...
    Mach1DecodePluginAttachmentPlugin,    // Authoring plug-in class to add to the plug-in container
