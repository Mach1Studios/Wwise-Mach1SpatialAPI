...
class Mach1DecodePluginPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    Mach1DecodePluginPlugin();
    ~Mach1DecodePluginPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(Mach1DecodePlugin);	// Exposes our PluginContainer structure that contains the info for our plugin
