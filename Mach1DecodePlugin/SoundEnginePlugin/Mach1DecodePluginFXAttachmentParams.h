...
#ifndef Mach1DecodePluginFXAttachmentParams_H
#define Mach1DecodePluginFXAttachmentParams_H
...
static const AkPluginParamID ATTACHMENT_PARAM_PLACEHOLDER_ID = 1000;
static const AkUInt32 ATTACHMENT_NUM_PARAMS = 1;

struct Mach1DecodePluginAttachmentRTPCParams
{
    AkReal32 fPlaceholder;
};

struct Mach1DecodePluginAttachmentNonRTPCParams
{
};

struct Mach1DecodePluginFXAttachmentParams
    : public AK::IAkPluginParam
{
    Mach1DecodePluginFXAttachmentParams();
    Mach1DecodePluginFXAttachmentParams(const Mach1DecodePluginFXAttachmentParams& in_rParams);
    ...
    AK::AkFXParameterChangeHandler<ATTACHMENT_NUM_PARAMS> m_paramChangeHandler;

    Mach1DecodePluginAttachmentRTPCParams RTPC;
    Mach1DecodePluginAttachmentNonRTPCParams NonRTPC;
};

#endif // Mach1DecodePluginFXAttachmentParams_H
