...
#ifndef Mach1DecodePluginFXParams_H
#define Mach1DecodePluginFXParams_H
...
struct Mach1DecodePluginRTPCParams
{
    AkReal32 fPlaceholder;
};

struct Mach1DecodePluginNonRTPCParams
{
};

struct Mach1DecodePluginFXParams
    : public AK::IAkPluginParam
{
    Mach1DecodePluginFXParams();
    Mach1DecodePluginFXParams(const Mach1DecodePluginFXParams& in_rParams);
    ...
    Mach1DecodePluginRTPCParams RTPC;
    Mach1DecodePluginNonRTPCParams NonRTPC;
};

#endif // Mach1DecodePluginFXParams_H
