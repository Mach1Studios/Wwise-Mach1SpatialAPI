...
local Plugin = {}
Plugin.name = "Mach1DecodePlugin"
Plugin.factoryheader = "../SoundEnginePlugin/Mach1DecodePluginFXFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "Mach1DecodePlugin.def",
    "Mach1DecodePlugin.xml",
    "*.rc",
}
